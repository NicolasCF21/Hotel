        ...
        <div class="container-fluid">
            <div class="row flex-nowrap">
                ...
                <div class="col-xl-10 col-sm-8 col-md-9 py-3">
                    <h3 class="text-start">Tipo de Habitaciones</h3>
                    <hr>
                    
                    <div class="row mb-3">                        
                        <div class="col-lg-12 col-sm-12 text-end">
                            <a class='btn btn-info btn-sm mt-1' href='http://localhost/hotel/adminHabitaciones/registrar_tipo.php' type='submit' id='btnActualizar' value='".$fila["id_habitacion"]."'><i class='bi bi-plus-circle me-2'></i>Añadir tipo </a>
                        </div>
                    </div>
                    <?php
