                ...
                <div class="col-xl-10 col-sm-8 col-md-9 py-3">
                    ...
                    <div class="row mb-2">                        
                        <div class="col-lg-12 text-end">
                            <a class='btn btn-info btn-sm mt-1' href='http://localhost/hotel/admin_empleados/registrar_cargo.php' type='submit' id='btnActualizar' value='".$fila["id_habitacion"]."'><i class='bi bi-plus-circle me-2'></i>Agregar Cargo </a>
                        </div>
                    </div>
                    <?php
        ...
        <script>
             function confirmar(id){
                ...
                if(confirm("¿Desea eliminar el cargo?")){
                    ...
                    alert("Cargo empleado eliminado correctamente");
                };
                xhttp.open("GET","eliminar_cargo.php?id="+id);
                xhttp.send();
                }
            }   
