            ...
            <div class="row flex-nowrap">
                ...
                <div class="col-xl-10 col-sm-8 col-md-9 py-3">
                    ...
                    <table class="table table-hover table-striped border" id="tabla" >
                        <tr><th>N°</th><th>Nombre</th><th>Apellido</th><th>Correo</th><th>No. Documento</th><th>No. Telefono</th><th></th></tr>
                        <?php
                            if($resultset->num_rows>0){
                                while($fila = $resultset->fetch_assoc()){
                                    ...
                                    <button class='btn btn-danger btn-sm' type='submit' id='btnEliminar' onclick='confirmar(this.value)' value='".$fila["id_usuario"]."'><i class='bi bi-person-x'></i> Eliminar</button></td></tr>";
