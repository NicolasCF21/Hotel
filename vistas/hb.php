...
$result = mysqli_query($conn, "SELECT COUNT(*) AS total FROM habitacion");
...
$query = "SELECT * FROM habitacion h 
JOIN tipo_habitacion t ON h.id_tipo_habitacion = t.id_tipo_habitacion LIMIT $primer_indice, $filas_por_pagina";
