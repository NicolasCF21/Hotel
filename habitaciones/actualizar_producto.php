            ...
            <div class="row flex-nowrap">
                ...
                <?php
                    if (isset($_GET['mensaje']) && $_GET['mensaje'] == 'actualizado') {
                        echo '<div class="alert alert-success m-0 alert-dismissible fade show" role="alert">
                            <i class="bi bi-check-circle-fill"></i><strong> ¡Exito!</strong> El producto fue actualizado correctamente
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>';  
                    }
                ?>
                <?php
                    if (isset($_GET['mensaje']) && $_GET['mensaje'] == 'error') {
                        echo '<div class="alert alert-danger m-0 alert-dismissible fade show" role="alert">
                            <i class="bi bi-exclamation-circle-fill"></i><strong> ¡Error!</strong> El producto no ha sido actualizado.
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>';  
                    }
                ?>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-floating my-3">
                                    ...
                                    <input type="text" id="producto" name="producto" class="form-control" placeholder="Producto habitación" value="<?php echo $fila['nombre_producto']; ?>  "required>
                                    <label for="producto">Producto Habitación:</label>
                                    <?php
                            ...
                            <div class="col-lg-6">
                                <div class="form-floating my-3">
                                    <input type="number" id="cantidad" name="cantidad" class="form-control" placeholder="Cantidad producto" value="<?php echo $fila["cantidad_producto"];?>" >
