    ...
    <body>
                ...
                <div class="col-xl-10 col-sm-10 col-md-9 py-3">
                    ...
                    <div class="row mb-3">                        
                        <div class="col-lg-12 col-sm-12 text-end">
                            <a class='btn btn-info btn-sm mt-1' href='http://localhost/hotel/habitaciones/registrar_producto.php' type='submit' id='btnActualizar' value='".$fila["id_habitacion"]."'><i class='bi bi-plus-circle me-2'></i>Añadir Producto</a>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped table-sm border" id="tabla" >
                            <thead>
                                <tr><th>N°</th><th>Producto</th><th>Cantidad</th><th>Acciones</th></tr>
                            </thead>
                            <tbody>
                            <?php
        ...
        <script>
             function confirmar(id){
                ...
                xhttp.open("GET","eliminar_producto.php?id="+id);
                xhttp.send();
                }
            }   
